        ...
        <UserLayout>
            {!User ? (
                <div className="flex flex-col items-center justify-center min-h-screen">
                    <h1 className="text-3xl font-bold">⚠️ Please login to view your cart..!</h1>
                    <button
                        onClick={() => navigate("/user/login")}
                        className="mt-6 bg-blue-500 text-white px-6 py-4 text-xl rounded-lg hover:bg-blue-600 transition-all duration-150 ease-in-out cursor-pointer"
                    >
                        Go to Login
                    </button>
                </div>
                        ...
                        {cartitems && cartitems.length > 0 ? (
                            cartitems.map((item, key) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <button
                                            className="ml-20 cursor-pointer text-2xl text-red-400"
                            ...
                            <div className="flex flex-col ">
                                ...
                                <button
                                    ...
                                    className="text-3xl bg-green-400 p-3 font-sans font-semibold rounded-xl hover:bg-green-500 transition-all duration-200 ease-in-out cursor-pointer py-5"
                                >
                                    View Order
                                </button>
                            </div>
